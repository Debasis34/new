...
<!-- End of Topbar -->
                ...
                <div id=tbphp>
                    ...
                    <form action="category.php" method="post" enctype="multipart/form-data">
                        ...
                        Enter custom name for the file:
                    ...
                    <table border="1">
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td><a href="category.php?delete_id=<?php echo $row['ID']; ?>" onclick="return confirm('Are you sure you want to delete this file?');">Delete</a></td>
                            </tr>
                        <?php } ?>
                    </table>
                </div>
